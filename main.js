...
function my_keydown(e)
{
	 ...
	 if(e.shiftKey == true && keyPressed == '67')
	 {
		...
		document.getElementById("curretWidth").innerHTML = block_image_width;
		document.getElementById("curretHeight").innerHTML = block_image_height;
	 }
